class App extends React.Component {
  ...
  render() {
    return (
      ...
      React.createElement("div", { className: "button", onClick: () => {this.initBoard();} }, "New Game"),

      React.createElement("div", { className: "buttons" },
      React.createElement("div", { className: "button", onClick: () => {this.move('up');} }, "Up"),
      React.createElement("div", { className: "button", onClick: () => {this.move('right');} }, "Right"),
      React.createElement("div", { className: "button", onClick: () => {this.move('down');} }, "Down"),
      React.createElement("div", { className: "button", onClick: () => {this.move('left');} }, "Left")),


      React.createElement("div", { className: "score" }, "Score: ", this.state.score),

      React.createElement("table", null,
      this.state.board.map((row, i) => React.createElement(Row, { key: i, row: row }))),
...
const Row = ({ row }) => {
  return (
    ...
    row.map((cell, i) => React.createElement(Cell, { key: i, cellValue: cell }))));
...
const Cell = ({ cellValue }) => {
  ...
  return (
    ...
    React.createElement("div", { className: "number" }, value))));
